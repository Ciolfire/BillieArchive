...
final class Version20220413165605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('CREATE TABLE characters_skills (id INT AUTO_INCREMENT NOT NULL, academics SMALLINT NOT NULL, computer SMALLINT NOT NULL, crafts SMALLINT NOT NULL, investigation SMALLINT NOT NULL, medecine SMALLINT NOT NULL, occult SMALLINT NOT NULL, politics SMALLINT NOT NULL, science SMALLINT NOT NULL, athletics SMALLINT NOT NULL, brawl SMALLINT NOT NULL, drive SMALLINT NOT NULL, firearms SMALLINT NOT NULL, larceny SMALLINT NOT NULL, stealth SMALLINT NOT NULL, survival SMALLINT NOT NULL, weaponry SMALLINT NOT NULL, animal_ken SMALLINT NOT NULL, empathy SMALLINT NOT NULL, expression SMALLINT NOT NULL, intimidation SMALLINT NOT NULL, persuasion SMALLINT NOT NULL, socialize SMALLINT NOT NULL, streetwise SMALLINT NOT NULL, subterfuge SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
