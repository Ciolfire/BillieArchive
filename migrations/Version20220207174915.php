...
final class Version20220207174915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE merits (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(40) NOT NULL, category VARCHAR(20) NOT NULL, is_fighting TINYINT(1) NOT NULL, is_expanded TINYINT(1) NOT NULL, min SMALLINT NOT NULL, max SMALLINT NOT NULL, is_unique TINYINT(1) NOT NULL, is_creation_only TINYINT(1) NOT NULL, prerequisites JSON DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
