...
final class Version20230129225029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prerequisite (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, entity_id INT NOT NULL, value SMALLINT NOT NULL, choice_group SMALLINT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
