 ...
 */
final class Version20250504185745 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mage_spell ADD CONSTRAINT FK_64EE380323DF3E0B FOREIGN KEY (arcanum_id) REFERENCES arcanum (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
