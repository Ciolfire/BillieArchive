...
class SocietyVoter extends Voter
{
  ...
  private function canView(Society $society, User $user): bool
  {
  ...
  private function canEdit(Society $society, User $user): bool
  {
    $chronicle = $society->getChronicle();
  ...
  private function canDelete(Society $society, User $user): bool
  {
